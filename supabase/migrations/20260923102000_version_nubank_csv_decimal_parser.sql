-- Nubank exports can use a dot as the decimal separator. New imports are
-- marked with the parser version that recognizes both supported layouts.
...
begin
  ...
  values (u,account,p_filename,p_storage_path,'text/csv',p_size_bytes,p_sha256,institution,'bank_statement','csv','nubank-statement-csv','2','processed',jsonb_array_length(p_rows),jsonb_array_length(p_rows)) returning id into import_id;
